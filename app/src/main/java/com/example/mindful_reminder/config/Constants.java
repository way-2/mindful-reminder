...
public class Constants {
    public static final String GRATITUDE_NOTIFICATION_WORKER = "GratitudeNotificationWorker";
    public static final String GRATITUDE_REDIRECT = "gratitudeRedirect";
    ...
    public static final String GRATITUDE_NOTIFICATION_TOGGLE = "gratitude_notification_toggle";
    ...
    public static final String GRATITUDE_NOTIFICATION_HOUR_LIST = "gratitude_notification_time_interval_list";
