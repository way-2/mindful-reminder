...
public class BodyScanMeditationFragmentTest {
    Resources resources = ApplicationProvider.getApplicationContext().getResources();

    @Test
    public void bodyScanMeditationFragmentTest() {
        String[] stepsArray = resources.getStringArray(R.array.body_scan);
        FragmentScenario.launchInContainer(BodyScanMeditationFragment.class, null);
